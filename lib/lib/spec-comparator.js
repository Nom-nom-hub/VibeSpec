 ...
 */
function compareSpecs(spec1, spec2) {
    const diff = {
        added: [],
        removed: [],
        modified: [],
 ...
 */
function compareBasicProperties(spec1, spec2, diff) {
 ...
 */
function compareArrays(array1, array2, diff, type) {
 ...
 */
function compareFeatures(features1, features2, diff) {
    const map1 = new Map();
    const map2 = new Map();
 ...
 */
function compareFeatureDetails(feature1, feature2, featureName, diff) {
